...
<section id="live-experience" class="py-20 sm:py-28">
    <div class="container-site space-y-12">
        <x-ui.section-header
            :eyebrow="__('site.live_experience.eyebrow')"
            eyebrowColor="text-purple"
            :title="__('site.live_experience.title')"
            :subtitle="__('site.live_experience.subtitle')"
        />

        <div class="group relative aspect-video overflow-hidden rounded-2xl">
            <x-ui.parallax-image
                :src="SiteSettings::liveVideoImage()"
                :alt="__('site.live_experience.image_alt')"
                fill
                speed="medium"
            />
            ...
            <a
                ...
                aria-label="{{ __('site.live_experience.play_label') }}"
            >
                ...
                <span class="text-xs font-semibold uppercase tracking-[0.2em] text-white">{{ __('site.buttons.watch_showreel') }}</span>
            </a>
        </div>
    </div>
</section>
